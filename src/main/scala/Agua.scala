...
object Agua {
  ...
  def main(args: Array[String]): Unit = {
   Logger.getLogger("org").setLevel(Level.WARN)
    ...
    val file = sc.textFile("Datos Agua/"+id+"/Edificio "+id+" 2017" + " agua" + ".csv")

    //val file = sc.textFile("Datos Agua/"+id+"/edificio "+id+" 2010" + " agua" + " 15min"+ ".csv") //Next
    ...
    println("-------------"+file.name+"---------------");
      ...
      println("Skewness: " + valuesStatistics.getSkewness()) //Oblique - Symmetry Coefficient ( Normal value between : +- 0.5)
      ...
      println("Variation Coefficient: " + variationCoefficient)
      ...
      println("Variation Coefficient: " + variationCoefficient2)
      ...
      println("Variation Coefficient: " + variationCoefficient3)
